...
public class App {
	...
	public static void main(String[] args) {
        ...
        User newUser = new User("Latifa Amougay", "employee", false, "latifa8@anmoon.ma", "password", 0);
...
//		System.out.println("### List Employees - start:");
//		List<User> employees = userRepository.listEmployees();
//		System.out.println("Employees found are :");
//		for (User employee : employees) {
//			System.out.println("-" + employee.toString());
//		}
//		System.out.println("### List Employees - end:");
