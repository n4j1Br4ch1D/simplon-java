...
//    private static final String PROPERTIES_DB_FILE = "src/main/java/config/dbconnection.properties";
...
//	 private static String databasePassword = properties.getProperty(PASS);
	 ...
	 public static Connection getConnection() {
		 ...
		 try{ 
			 ...
			 return DriverManager.getConnection("jdbc:postgresql://localhost:5432/Doer", "postgres", "root" );
