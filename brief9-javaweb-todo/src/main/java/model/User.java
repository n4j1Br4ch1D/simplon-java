...
// Entity : direct representation of a storage structure (more often - a database table).
// Domain in world of java //Model
//POJO (Plain Old Java Object) class defn not tied to any framework
//Class Bean
...
public class User {
	...
	private Integer id; //Long //integer (doesnt accept null (empty)) /uid
